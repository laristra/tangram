...
//!
//!~~~
//! Tangram::Element_type cell_get_element_type(int const cellid) const;
//!~~~
//!
//! Can be Tangram::UNKNOWN_TOPOLOGY, Tangram::TRI, Tangram::QUAD,
//! Tangram::POLYGON, Tangram::TET, Tangram::PRISM, Tangram::PYRAMID,
//! Tangram::HEX, Tangram::POLYHEDRON
//!
//!
//!~~~
...
//!
//! void face_get_cells(int const faceid, Tangram::Entity_type etype,
//!                     std::vector<int> *fcells) const;
//!
//! void node_get_cells(int const nodeid, Tangram::Entity_type etype,
//!                     std::vector<int> *ncells) const;
//!
//! int get_global_id(int const id, Entity_kind const kind) const;
//!
//! template<long D>
//! void node_get_coordinates(int const nodeid, Tangram::Point<D> *pp) const;
//!
//!~~~
//! ******************************** NOTE ***********************************
//!
...
class AuxMeshTopology {
 public:
  ...
  int num_entities(Tangram::Entity_kind const entity,
      ...
      const {
    return num_entities(static_cast<Tangram::Entity_kind>(entity),
                        static_cast<Tangram::Entity_type>(etype));
  }
#endif
  ...
  counting_iterator begin(Tangram::Entity_kind const entity,
    ...
    return begin(static_cast<Tangram::Entity_kind>(entity),
                 static_cast<Tangram::Entity_type>(etype));
  }
  ...
  counting_iterator end(Tangram::Entity_kind const entity,
                        Tangram::Entity_type const etype = Tangram::Entity_type::ALL) const {
    return end(static_cast<Tangram::Entity_kind>(entity),
               static_cast<Tangram::Entity_type>(etype));
  }
#endif
  /*!
    ...
    if (planar_hex
      ...
      */
      ...
      for (unsigned int t = 0; t < 5; t++) {
        std::array<Tangram::Point<3>, 4> tmp;
        for (int i = 0; i < 4; i++) {
          for (int j = 0; j < 3; j++) {
 ...
 private:
  ...
  // declarations std::vector<Tangram::Point<D>>
